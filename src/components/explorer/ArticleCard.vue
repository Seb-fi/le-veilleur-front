...
defineProps<{ article: ExplorerArticle }>()
</script>
  ...
  <article class="article">
    <div class="article-body">
      ...
      <div class="card-links">
        <a class="card-link" href="#" title="Ouvrir la source originale">
        ...
        <a class="card-link" href="#" title="Articles liés">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
